...
<div class="fixed-sidebar-left">
    <ul class="nav navbar-nav side-nav nicescroll-bar">
        ...
        <li>
            <a class="{{ Request::url() == url('/admin/users/clents') || Request::url() == url('/admin/user/drivers') ? 'active' : '' }}" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left">
