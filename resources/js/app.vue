        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3 col-sm-10 col-xs-10">
                    <div class="site-logo">
                        <a href="index.html"><img  class="mlogo" style="margin-top: -40px" src="assets/images/heart-of-gold.png" alt="logo" /></a>
                    </div><!-- /.logo -->
                </div><!-- /.col-md-3 -->
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="widget widget_about">
                            ...
                            <div class="widget-about-content">
                                ...
                                <p>Heart of Gold Medical Transport is a family-owned non-emergency medical transportation company serving the greater Sacramento area since 2016. Its owners are Megan and Cecilia.

                                    Megan has worked as a nurse since 2009, becoming a Registered Nurse</p>
                                <a href="/about" class="button">Reade More</a>
                            </div><!-- /.widget-content -->
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="widget widget_hot_contact">
                            ...
                            <ul>
                                ...
                                <li><a href="#"><i class="fa fa-map-marker"></i>1329 Howe Ave #205, Sacramento, CA 95825</a></li>
                            </ul>
                        </div><!-- /.widget -->
                    </div><!-- /.col-md-3 -->
                ...
                <div class="row">
                     <div class="col-md-9">
                        <div class="bottom-content-left">
                            <p class="copyright">Copyright &copy;  2020 Heart of Gold</p>
