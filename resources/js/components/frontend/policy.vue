        ...
        <div class="contact-us-area mr-top-60">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="policy-cs">
                            <h1 class="MuiTypography-root MuiTypography-h1">Privacy Policy</h1>
                            <p class="policy-cs-p">Last updated: March 31, 2021</p>
                            <p class="policy-cs-p">This Privacy Policy describes Our
                            ...
                            <p class="policy-cs-p">We use Your Personal data to
                            ...
                            <p class="policy-cs-p">The words of which the initial
                            ...
                            <h2>Definitions</h2>
                            <p class="policy-cs-p">For the purposes of this Privacy
                                Policy:</p>
                            <ul class="MuiList-root MuiList-padding">
                                <li>
                                    <p class="policy-cs-p"><strong>Account</strong>
                                        means a unique account created for You to access our Service or parts of
                                        our Service.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Business</strong>,
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>Company</strong>
                                        ...
                                        #205, Sacramento, CA 95825.</p>
                                    <p class="policy-cs-p">For the purpose of the
                                        GDPR, the Company is the Data Controller.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Consumer</strong>,
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>Cookies</strong>
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>Country</strong>
                                        refers to: California, United States</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Data
                                            Controller</strong>, for the purposes of the GDPR (General Data
                                        Protection Regulation), refers to the Company as the legal person which
                                        alone or jointly with others determines the purposes and means of the
                                        processing of Personal Data.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Device</strong>
                                        means any device that can access the Service such as a computer, a
                                        cellphone or a digital tablet.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Do Not
                                            Track</strong> (DNT) is a concept that has been promoted by US
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>Facebook Fan
                                            Page</strong> is a public profile named Heart of Gold Medical
                                        Transport, Inc. specifically created by the Company on the Facebook
                                        social network, accessible from <a
                                            href="https://www.facebook.com/heartofgoldmedtransport"
                                            rel="external nofollow noopener"
                                            target="_blank">https://www.facebook.com/heartofgoldmedtransport</a>
                                    </p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Personal
                                            Data</strong> is any information that relates to an identified or
                                        identifiable individual.</p>
                                    <p class="policy-cs-p">For the purposes for GDPR,
                                    ...
                                    <p class="policy-cs-p">For the purposes of the
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>Sale</strong>, for
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>Service</strong>
                                        refers to the Website.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Service
                                            Provider</strong> means any natural or legal person who processes
                                        ...
                                        considered Data Processors.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Third-party Social
                                            Media Service</strong> refers to any website or any social network
                                        website through which a User can log in or create an account to use the
                                        Service.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Usage
                                            Data</strong> refers to data collected automatically, either
                                        generated by the use of the Service or from the Service infrastructure
                                        itself (for example, the duration of a page visit).</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Website</strong>
                                        refers to Heart of Gold Medical Transport Inc, accessible from <a
                                            href="https://www.heartofgoldmedtransport.com/"
                                            rel="external nofollow noopener"
                                            target="_blank">https://www.heartofgoldmedtransport.com/</a></p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>You</strong> means
                                        ...
                                        the Service, as applicable.</p>
                                    <p class="policy-cs-p">Under GDPR (General Data
                            ...
                            <h3>Personal Data</h3>
                            <p class="policy-cs-p">While using Our Service, We may
                            ...
                            <ul class="MuiList-root MuiList-padding">
                                <li>
                                    <p class="policy-cs-p">Email address</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p">First name and last name
                                    </p>
                                </li>
                                <li>
                                    <p class="policy-cs-p">Phone number</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p">Address, State, Province,
                                        ZIP/Postal code, City</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p">Usage Data</p>
                                </li>
                            </ul>
                            <h3>Usage Data</h3>
                            <p class="policy-cs-p">Usage Data is collected
                                automatically when using the Service.</p>
                            <p class="policy-cs-p">Usage Data may include information
                                ...
                                diagnostic data.</p>
                            <p class="policy-cs-p">When You access the Service by or
                            ...
                            <p class="policy-cs-p">We may also collect information
                                that Your browser sends whenever You visit our Service or when You access the
                                Service by or through a mobile device.</p>
                            <h3>Tracking Technologies and Cookies</h3>
                            <p class="policy-cs-p">We use Cookies and similar
                            ...
                            <ul class="MuiList-root MuiList-padding">
                                <li><strong>Cookies or Browser Cookies.</strong> A cookie is a small file placed
                                    ...
                                    may use Cookies.</li>
                                <li><strong>Flash Cookies.</strong> Certain features of our Service may use
                            ...
                            <p class="policy-cs-p">Cookies can be "Persistent" or
                            ...
                            <p class="policy-cs-p">We use both Session and Persistent
                                Cookies for the purposes set out below:</p>
                            <ul class="MuiList-root MuiList-padding">
                                <li>
                                    <p class="policy-cs-p"><strong>Necessary /
                                            Essential Cookies</strong></p>
                                    <p class="policy-cs-p">Type: Session Cookies</p>
                                    <p class="policy-cs-p">Administered by: Us</p>
                                    <p class="policy-cs-p">Purpose: These Cookies are
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>Cookies Policy /
                                            Notice Acceptance Cookies</strong></p>
                                    <p class="policy-cs-p">Type: Persistent Cookies
                                    </p>
                                    <p class="policy-cs-p">Administered by: Us</p>
                                    <p class="policy-cs-p">Purpose: These Cookies
                                        identify if users have accepted the use of cookies on the Website.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Functionality
                                            Cookies</strong></p>
                                    <p class="policy-cs-p">Type: Persistent Cookies
                                    </p>
                                    <p class="policy-cs-p">Administered by: Us</p>
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>Tracking and
                                            Performance Cookies</strong></p>
                                    <p class="policy-cs-p">Type: Persistent Cookies
                                    </p>
                                    <p class="policy-cs-p">Administered by:
                                        Third-Parties</p>
                                    <p class="policy-cs-p">Purpose: These Cookies are
                            ...
                            <p class="policy-cs-p">For more information about the
                            ...
                            <p class="policy-cs-p">The Company may use Personal Data
                                for the following purposes:</p>
                            <ul class="MuiList-root MuiList-padding">
                                <li>
                                    <p class="policy-cs-p"><strong>To provide and
                                            maintain our Service</strong>, including to monitor the usage of our
                                        Service.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>To manage Your
                                            Account:</strong> to manage Your registration as a user of the
                                        Service. The Personal Data You provide can give You access to different
                                        functionalities of the Service that are available to You as a registered
                                        user.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>For the
                                            performance of a contract:</strong> the development, compliance and
                                        undertaking of the purchase contract for the products, items or services
                                        You have purchased or of any other contract with Us through the Service.
                                    </p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>To contact
                                            You:</strong> To contact You by email, telephone calls, SMS, or
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>To provide
                                            You</strong> with news, special offers and general information about
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>For business
                                            transfers:</strong> We may use Your information to evaluate or
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>For other
                                            purposes</strong>: We may use Your information for other purposes,
                            ...
                            <p class="policy-cs-p">We may share Your personal
                            ...
                            <p class="policy-cs-p">The Company will retain Your
                            ...
                            <p class="policy-cs-p">The Company will also retain Usage
                            ...
                            <p class="policy-cs-p">Your information, including
                            ...
                            <p class="policy-cs-p">Your consent to this Privacy
                                Policy followed by Your submission of such information represents Your agreement
                                to that transfer.</p>
                            <p class="policy-cs-p">The Company will take all steps
                            ...
                            <p class="policy-cs-p">If the Company is involved in a
                            ...
                            <p class="policy-cs-p">Under certain circumstances, the
                            ...
                            <p class="policy-cs-p">The Company may disclose Your
                            ...
                            <p class="policy-cs-p">The security of Your Personal Data
                            ...
                            <p class="policy-cs-p">The Service Providers We use may
                            ...
                            <h2>Analytics</h2>
                            <p class="policy-cs-p">We may use third-party Service
                                providers to monitor and analyze the use of our Service.</p>
                            <ul class="MuiList-root MuiList-padding">
                                <li>
                                    <p class="policy-cs-p"><strong>Google
                                            Analytics</strong></p>
                                    <p class="policy-cs-p">Google Analytics is a web
                                    ...
                                    <p class="policy-cs-p">You can opt-out of having
                                    ...
                                    <p class="policy-cs-p">For more information on
                                        the privacy practices of Google, please visit the Google Privacy &amp;
                                        Terms web page: <a href="https://policies.google.com/privacy"
                                            rel="external nofollow noopener"
                                ...
                                <li>
                                    ...
                                    <p class="policy-cs-p">Their Privacy Policy can
                                        be viewed at <a href="https://www.salesforce.com/company/privacy/"
                                            rel="external nofollow noopener"
                                            target="_blank">https://www.salesforce.com/company/privacy/</a></p>
                                </li>
                            </ul>
                            <h2>Email Marketing</h2>
                            <p class="policy-cs-p">We may use Your Personal Data to
                            ...
                            <p class="policy-cs-p">We may use Email Marketing Service
                                Providers to manage and send emails to You.</p>
                            <ul class="MuiList-root MuiList-padding">
                                <li>
                                    <p class="policy-cs-p"><strong>SendGrid</strong>
                                    </p>
                                    <p class="policy-cs-p">Their Privacy Policy can
                                        be viewed at <a href="https://www.twilio.com/legal/privacy"
                                            rel="external nofollow noopener"
                                            target="_blank">https://www.twilio.com/legal/privacy</a></p>
                                </li>
                            </ul>
                            <h1>GDPR Privacy</h1>
                            <h2>Legal Basis for Processing Personal Data under GDPR</h2>
                            <p class="policy-cs-p">We may process Personal Data under
                                the following conditions:</p>
                            <ul class="MuiList-root MuiList-padding">
                                <li><strong>Consent:</strong> You have given Your consent for processing
                                    Personal Data for one or more specific purposes.</li>
                                ...
                                <li><strong>Legal obligations:</strong> Processing Personal Data is necessary
                                    for compliance with a legal obligation to which the Company is subject.</li>
                                <li><strong>Vital interests:</strong> Processing Personal Data is necessary in
                                    order to protect Your vital interests or of another natural person.</li>
                                <li><strong>Public interests:</strong> Processing Personal Data is related to a
                                    ...
                                    official authority vested in the Company.</li>
                                <li><strong>Legitimate interests:</strong> Processing Personal Data is necessary
                                    for the purposes of the legitimate interests pursued by the Company.</li>
                            </ul>
                            <p class="policy-cs-p">In any case, the Company will
                            ...
                            <p class="policy-cs-p">The Company undertakes to respect
                                the confidentiality of Your Personal Data and to guarantee You can exercise Your
                                rights.</p>
                            <p class="policy-cs-p">You have the right under this
                                Privacy Policy, and by law if You are within the EU, to:</p>
                            <ul class="MuiList-root MuiList-padding">
                                <li><strong>Request access to Your Personal Data.</strong> The right to access,
                                    ...
                                    a copy of the Personal Data We hold about You.</li>
                                <li><strong>Request correction of the Personal Data that We hold about
                                        You.</strong> You have the right to have any incomplete or inaccurate
                                    information We hold about You corrected.</li>
                                <li><strong>Object to processing of Your Personal Data.</strong> This right
                                    ...
                                    Personal Data for direct marketing purposes.</li>
                                <li><strong>Request erasure of Your Personal Data.</strong> You have the right
                                    to ask Us to delete or remove Personal Data when there is no good reason for
                                    Us to continue processing it.</li>
                                <li><strong>Request the transfer of Your Personal Data.</strong> We will provide
                                    ...
                                    with You.</li>
                                <li><strong>Withdraw Your consent.</strong> You have the right to withdraw Your
                            ...
                            <p class="policy-cs-p">You may exercise Your rights of
                                ...
                                possible.</p>
                            <p class="policy-cs-p">You have the right to complain to
                                ...
                                contact Your local data protection authority in the EEA.</p>
                            <h1>Facebook Fan Page</h1>
                            <h2>Data Controller for the Facebook Fan Page</h2>
                            <p class="policy-cs-p">The Company is the Data Controller
                                of Your Personal Data collected while using the Service. As operator of the
                                Facebook Fan Page <a href="https://www.facebook.com/heartofgoldmedtransport"
                                    rel="external nofollow noopener"
                                    target="_blank">https://www.facebook.com/heartofgoldmedtransport</a>, the
                                Company and the operator of the social network Facebook are Joint Controllers.
                            </p>
                            <p class="policy-cs-p">The Company has entered into
                                ...
                                Service: <a href="https://www.facebook.com/terms.php" rel="external nofollow noopener"
                                    target="_blank">https://www.facebook.com/terms.php</a></p>
                            <p class="policy-cs-p">Visit the Facebook Privacy Policy
                                <a href="https://www.facebook.com/policy.php" rel="external nofollow noopener"
                                    target="_blank">https://www.facebook.com/policy.php</a> for more information
                            ...
                            <p class="policy-cs-p">We use the Facebook Insights
                                ...
                                users.</p>
                            <p class="policy-cs-p">For this purpose, Facebook places
                                ...
                                except when it is deleted before the end of this period.</p>
                            <p class="policy-cs-p">Facebook receives, records and
                            ...
                            <p class="policy-cs-p">For more information on the
                                privacy practices of Facebook, please visit Facebook Privacy Policy here: <a
                                    href="https://www.facebook.com/full_data_use_policy"
                                    rel="external nofollow noopener"
                                    target="_blank">https://www.facebook.com/full_data_use_policy</a></p>
                            <h1>CCPA Privacy</h1>
                            <p class="policy-cs-p">This privacy notice section for
                            ...
                            <p class="policy-cs-p">We collect information that
                            ...
                            <p class="policy-cs-p">Please note that the categories
                                ...
                                only be collected if You provided such personal information directly to Us.</p>
                            <ul class="MuiList-root MuiList-padding">
                                <li>
                                    <p class="policy-cs-p"><strong>Category A:
                                            Identifiers.</strong></p>
                                    <p class="policy-cs-p">Examples: A real name,
                                    ...
                                    <p class="policy-cs-p">Collected: Yes.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Category B:
                                            Personal information categories listed in the California Customer
                                            Records statute (Cal. Civ. Code § 1798.80(e)).</strong></p>
                                    <p class="policy-cs-p">Examples: A name,
                                ...
                                <li>
                                    <p class="policy-cs-p"><strong>Category C:
                                            Protected classification characteristics under California or federal
                                            law.</strong></p>
                                    <p class="policy-cs-p">Examples: Age (40 years or
                                        ...
                                        information).</p>
                                    <p class="policy-cs-p">Collected: No.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Category D:
                                            Commercial information.</strong></p>
                                    <p class="policy-cs-p">Examples: Records and
                                        history of products or services purchased or considered.</p>
                                    <p class="policy-cs-p">Collected: No.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Category E:
                                            Biometric information.</strong></p>
                                    <p class="policy-cs-p">Examples: Genetic,
                                        ...
                                        health, or exercise data.</p>
                                    <p class="policy-cs-p">Collected: No.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Category F:
                                            Internet or other similar network activity.</strong></p>
                                    <p class="policy-cs-p">Examples: Interaction with
                                        our Service or advertisement.</p>
                                    <p class="policy-cs-p">Collected: Yes.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Category G:
                                            Geolocation data.</strong></p>
                                    <p class="policy-cs-p">Examples: Approximate
                                        physical location.</p>
                                    <p class="policy-cs-p">Collected: No.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Category H:
                                            Sensory data.</strong></p>
                                    <p class="policy-cs-p">Examples: Audio,
                                        electronic, visual, thermal, olfactory, or similar information.</p>
                                    <p class="policy-cs-p">Collected: No.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Category I:
                                            Professional or employment-related information.</strong></p>
                                    <p class="policy-cs-p">Examples: Current or past
                                        job history or performance evaluations.</p>
                                    <p class="policy-cs-p">Collected: No.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Category J:
                                            Non-public education information (per the Family Educational Rights
                                            and Privacy Act (20 U.S.C. Section 1232g, 34 C.F.R. Part
                                            99)).</strong></p>
                                    <p class="policy-cs-p">Examples: Education
                                        ...
                                        financial information, or student disciplinary records.</p>
                                    <p class="policy-cs-p">Collected: No.</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p"><strong>Category K:
                                            Inferences drawn from other personal information.</strong></p>
                                    <p class="policy-cs-p">Examples: Profile
                            ...
                            <p class="policy-cs-p">Under CCPA, personal information
                                does not include:</p>
                            <ul class="MuiList-root MuiList-padding">
                                ...
                                <li>Information excluded from the CCPA's scope, such as:<ul
                                        ...
                                        <li>Personal Information covered by certain sector-specific privacy
                            ...
                            <p class="policy-cs-p">We obtain the categories of
                                personal information listed above from the following categories of sources:</p>
                            <ul class="MuiList-root MuiList-padding">
                                <li><strong>Directly from You</strong>. For example, from the forms You complete
                                    on our Service, preferences You express or provide through our Service.</li>
                                <li><strong>Indirectly from You</strong>. For example, from observing Your
                                    activity on our Service.</li>
                                <li><strong>Automatically from You</strong>. For example, through cookies We or
                                    our Service Providers set on Your Device as You navigate through our
                                    Service.</li>
                                <li><strong>From Service Providers</strong>. For example, third-party vendors to
                            ...
                            <p class="policy-cs-p">We may use or disclose personal
                            ...
                            <ul class="MuiList-root MuiList-padding">
                                ...
                                <li>To fulfill or meet the reason You provided the information. For example, if
                                    You share Your contact information to ask a question about our Service, We
                                    will use that personal information to respond to Your inquiry.</li>
                            ...
                            <p class="policy-cs-p">Please note that the examples
                            ...
                            <p class="policy-cs-p">If We decide to collect additional
                            ...
                            <h2>Disclosure of Personal Information for Business Purposes or Commercial Purposes
                            </h2>
                            <p class="policy-cs-p">We may use or disclose and may
                            ...
                            <ul class="MuiList-root MuiList-padding">
                                <li>
                                    <p class="policy-cs-p">Category A: Identifiers
                                    </p>
                                </li>
                                <li>
                                    <p class="policy-cs-p">Category B: Personal
                                        information categories listed in the California Customer Records statute
                                        (Cal. Civ. Code § 1798.80(e))</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p">Category F: Internet or
                                        other similar network activity</p>
                                </li>
                            </ul>
                            <p class="policy-cs-p">Please note that the categories
                                ...
                                from the applicable category may be and may have been disclosed.</p>
                            <p class="policy-cs-p">When We disclose personal
                            ...
                            <p class="policy-cs-p">As defined in the CCPA, "sell" and
                            ...
                            <p class="policy-cs-p">Please note that the categories
                                ...
                                return.</p>
                            <p class="policy-cs-p">We may sell and may have sold in
                            ...
                            <ul class="MuiList-root MuiList-padding">
                                <li>
                                    <p class="policy-cs-p">Service Providers</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p">Our affiliates</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p">Our business partners</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p">Third party vendors to
                            ...
                            <p class="policy-cs-p">We do not knowingly collect
                            ...
                            <p class="policy-cs-p">We do not sell the personal
                                ...
                                contacting Us.</p>
                            <p class="policy-cs-p">If You have reason to believe that
                            ...
                            <p class="policy-cs-p">The CCPA provides California
                            ...
                            <ul class="MuiList-root MuiList-padding">
                                <li><strong>The right to notice.</strong> You have the right to be notified
                                    which categories of Personal Data are being collected and the purposes for
                                    which the Personal Data is being used.</li>
                                <li><strong>The right to request.</strong> Under CCPA, You have the right to
                                    ...
                                    receive and confirm Your request, We will disclose to You:<ul
                                        class="MuiList-root MuiList-padding">
                                        ...
                                        <li>If we sold Your personal information or disclosed Your personal
                                            information for a business purpose, We will disclose to You:<ul
                                                class="MuiList-root MuiList-padding">
                                                <li>The categories of personal information categories sold</li>
                                                <li>The categories of personal information categories disclosed
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li><strong>The right to say no to the sale of Personal Data (opt-out).</strong>
                                    You have the right to direct Us to not sell Your personal information. To
                                    submit an opt-out request please contact Us.</li>
                                <li><strong>The right to delete Personal Data.</strong> You have the right to
                                    ...
                                    the information is necessary for Us or Our Service Providers to:<ul
                                        class="MuiList-root MuiList-padding">
                                        ...
                                        <li>Exercise free speech, ensure the right of another consumer to
                                            exercise their free speech rights, or exercise another right
                                            provided for by law.</li>
                                        <li>Comply with the California Electronic Communications Privacy Act
                                            (Cal. Penal Code § 1546 et. seq.).</li>
                                        <li>Engage in public or peer-reviewed scientific, historical, or
                                        ...
                                        <li>Enable solely internal uses that are reasonably aligned with
                                            consumer expectations based on Your relationship with Us.</li>
                                        <li>Comply with a legal obligation.</li>
                                ...
                                <li><strong>The right not to be discriminated against.</strong> You have the
                                    right not to be discriminated against for exercising any of Your consumer's
                                    rights, including by:<ul class="MuiList-root MuiList-padding">
                                        <li>Denying goods or services to You</li>
                                        <li>Charging different prices or rates for goods or services, including
                                            the use of discounts or other benefits or imposing penalties</li>
                                        <li>Providing a different level or quality of goods or services to You
                                        </li>
                                        <li>Suggesting that You will receive a different price or rate for goods
                            ...
                            <p class="policy-cs-p">In order to exercise any of Your
                                rights under the CCPA, and if You are a California resident, You can contact Us:
                            </p>
                            <ul class="MuiList-root MuiList-padding">
                                <li>
                                    <p class="policy-cs-p">By email:
                                        contact@heartofgoldmedtransport.com</p>
                                </li>
                                <li>
                                    <p class="policy-cs-p">By visiting this page on
                                        our website: <a href="https://www.heartofgoldmedtransport.com/contact"
                                            rel="external nofollow noopener"
                                            target="_blank">https://www.heartofgoldmedtransport.com/contact</a>
                                    </p>
                                </li>
                                <li>
                                    <p class="policy-cs-p">By phone number:
                                        9167406447</p>
                                </li>
                            </ul>
                            <p class="policy-cs-p">Only You, or a person registered
                            ...
                            <p class="policy-cs-p">Your request to Us must:</p>
                            <ul class="MuiList-root MuiList-padding">
                                ...
                                <li>Describe Your request with sufficient detail that allows Us to properly
                                    understand, evaluate, and respond to it</li>
                            </ul>
                            <p class="policy-cs-p">We cannot respond to Your request
                                or provide You with the required information if We cannot:</p>
                            <ul class="MuiList-root MuiList-padding">
                                <li>Verify Your identity or authority to make the request</li>
                                <li>And confirm that the personal information relates to You</li>
                            </ul>
                            <p class="policy-cs-p">We will disclose and deliver the
                            ...
                            <p class="policy-cs-p">Any disclosures We provide will
                                only cover the 12-month period preceding the verifiable request's receipt.</p>
                            <p class="policy-cs-p">For data portability requests, We
                                ...
                                another entity without hindrance.</p>
                            <h2>Do Not Sell My Personal Information</h2>
                            <p class="policy-cs-p">You have the right to opt-out of
                                ...
                                exercise Your right to opt-out, please contact Us.</p>
                            <p class="policy-cs-p">The Service Providers we partner
                                ...
                                may do so by following the instructions below.</p>
                            <p class="policy-cs-p">Please note that any opt out is
                                specific to the browser You use. You may need to opt out on every browser that
                                You use.</p>
                            <h3>Website</h3>
                            <p class="policy-cs-p">You can opt out of receiving ads
                            ...
                            <ul class="MuiList-root MuiList-padding">
                                <li>The NAI's opt-out platform: <a href="http://www.networkadvertising.org/choices/"
                                        rel="external nofollow noopener"
                                        target="_blank">http://www.networkadvertising.org/choices/</a></li>
                                ...
                                <li>The DAA's opt-out platform: <a href="http://optout.aboutads.info/?c=2&amp;lang=EN"
                                        rel="external nofollow noopener"
                                        target="_blank">http://optout.aboutads.info/?c=2&amp;lang=EN</a></li>
                            </ul>
                            <p class="policy-cs-p">The opt out will place a cookie on
                            ...
                            <p class="policy-cs-p">Your mobile device may give You
                            ...
                            <p class="policy-cs-p">You can also stop the collection
                                of location information from Your mobile device by changing the preferences on
                                Your mobile device.</p>
                            <h1>"Do Not Track" Policy as Required by California Online Privacy Protection Act
                                (CalOPPA)</h1>
                            <p class="policy-cs-p">Our Service does not respond to Do
                                Not Track signals.</p>
                            <p class="policy-cs-p">However, some third party websites
                            ...
                            <p class="policy-cs-p">Our Service does not address
                            ...
                            <p class="policy-cs-p">If We need to rely on consent as a
                            ...
                            <p class="policy-cs-p">Under California Civil Code
                            ...
                            <p class="policy-cs-p">If you'd like to request more
                                ...
                                below.</p>
                            <h1>California Privacy Rights for Minor Users (California Business and Professions
                                Code Section 22581)</h1>
                            <p class="policy-cs-p">California Business and
                                ...
                                and obtain removal of content or information they have publicly posted.</p>
                            <p class="policy-cs-p">To request removal of such data,
                                ...
                                account.</p>
                            <p class="policy-cs-p">Be aware that Your request does
                            ...
                            <p class="policy-cs-p">Our Service may contain links to
                            ...
                            <p class="policy-cs-p">You are advised to review this
                                Privacy Policy periodically for any changes. Changes to this Privacy Policy are
                                effective when they are posted on this page.</p>
                            <h1>Contact Us</h1>
                            <p class="policy-cs-p">If you have any questions about
                                this Privacy Policy, You can contact us:</p>
                            <ul class="MuiList-root MuiList-padding">
                                <li>
                                    <p class="policy-cs-p">By email:
                                        contact@heartofgoldmedtransport.com</p>
